...
const AccessSelected = ({ navigation,route }) => {
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={{ alignSelf: "center",flex:1,justifyContent:'center',marginBottom:"32%"}}>
          ...
          <Text style={{color: "#fff",
              ...
              paddingLeft:15,
              paddingRight:15,
              textAlign:"center"}}>Please make sure that you are within 50 meters of the venue you are trying to access before attempting to queue jump.</Text>
        <View style={{width:280,height:180,justifyContent:'center',alignSelf:'center',}}>
          <Lottie
    source={require('../../assets/Image/130449-access-denied.json')}
