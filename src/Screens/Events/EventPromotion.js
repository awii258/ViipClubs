import {
  ...
  const EventPromotion = ({ HEIGHT }) => {
    ...
    const { state, onEvents, onEventByTowns,onEventByType,onEventTown } = useContext(Actions);
    ...
    console.log('hell this his event',state.eventType)
    ...
    //   // );
    //   // setShowEvents([]);
    //   onEventByType("","","","",productTitle,"","Major Event","");
    //   // console.log(
    //   //   "Towns==============================>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>towns",
    //   //   town
    //   // );
